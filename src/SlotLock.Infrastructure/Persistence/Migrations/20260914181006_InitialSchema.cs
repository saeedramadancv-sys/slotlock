        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Slots_ReservedWithinCapacity", "[ReservedCount] >= 0 AND [ReservedCount] <= [Capacity]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    HoldExpiresAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "UX_IdempotencyRecords_Key_Endpoint",
                table: "IdempotencyRecords",
